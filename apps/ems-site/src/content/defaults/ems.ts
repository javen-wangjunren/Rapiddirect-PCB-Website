export const emsHomeDefaults = {
  hero: {
    ...
    benefit_conclusion:
      'End-to-end EMS solutions optimizing your product development and rapid delivery.',
    cta: {
  ...
  services: {
    title: 'Our Services',
    description:
      'Comprehensive electronics manufacturing solutions from design to delivery',
    items: [
      {
        name: 'PCB Design',
        description: {
  ...
  quality: {
    ...
    description:
      'Rigorous quality assurance at every stage - from pre-production planning to final delivery',
    tabs: [
      {
        id: 'pre_production',
          ...
          functions: [
            {
              ...
              description:
                'Comprehensive file validation and design verification to ensure manufacturability'
            },
            {
              icon_url: '/icons/quality-control/mocbk63g-vi7fb7g.svg',
              name: 'Premium Material Selection',
              description:
                'Top-tier materials from trusted brands: Shengyi, Rogers, Isola, and other industry leaders'
            }
          ]
        }
      },
    ...
    advantages: [
      ...
      {
        title: 'ISO 9001',
        description: 'Certified Quality System'
      },
      {
        title: '24/7',
    ...
    items: [
      {
        tab: {
          id: 'automotive',
          name: 'Automotive',
          icon_url: '/icons/industry/moccppwh-hgq3v1b.svg'
        },
        card: {
      ...
      },
      {
        tab: {
          ...
          icon_url: '/icons/industry/moccppwh-e2k7lay.svg'
        },
        card: {
      ...
      },
      {
        tab: {
          ...
          icon_url: '/icons/industry/moccppwi-pxjtcjy.svg'
        },
        card: {
      ...
      },
      {
        tab: {
          ...
          icon_url: '/icons/industry/moccppwi-apqk1ey.svg'
        },
        card: {
      ...
      },
      {
        tab: {
          ...
          icon_url: '/icons/industry/moccppwi-dnhnbhu.svg'
        },
        card: {
      ...
      },
      {
        tab: {
          id: 'aerospace',
          name: 'Aerospace',
          icon_url: '/icons/industry/moccppwi-eihm471.svg'
        },
        card: {
  ...
  why_choose_us: {
    ...
    description:
      'Time is your most expensive resource. By synchronizing PCB fabrication with mechanical prototyping (CNC, Sheet Metal, 3D Printing), we cut weeks off your development cycle. Real-time DFM for both electronics and mechanics ensures your design is optimized for mass production from day one.',
    cards: [
      {
        icon_url: '/icons/why-choose/mochqtw9-e5dkrdg.svg',
        title: 'Mechanical-Electronic Synergy',
        description:
          'We validate your PCB layout against your CNC or Injection Molded enclosure in real-time. No more "it doesn’t fit" surprises during assembly.'
      },
      {
        icon_url: '/icons/why-choose/mochqtw9-zk9tmlj.svg',
        title: 'Hardware-Speed Prototyping',
        description:
          'Sync your PCB fabrication with mechanical parts. Get your entire functional prototype in one shipment, cutting weeks off your NPI cycle.'
      },
      {
        icon_url: '/icons/why-choose/mochqtw9-g44gh2u.svg',
        title: 'Zero-Friction Logistics',
        description:
          'Eliminate the cost and risk of shipping parts between multiple factories. We handle the integration, you handle the innovation.'
      }
    ]
  },
  order_process: {
    ...
    steps: [
      {
        icon_url: '/icons/order-process/moci20k9-0273m4o.svg',
        title: 'Design Review & DFM Check'
      },
      {
        icon_url: '/icons/order-process/moci20k9-kfex64c.svg',
        title: 'PCB Manufacturing'
      },
      {
        icon_url: '/icons/order-process/moci20k9-ep6oz7h.svg',
        title: 'Components Procurement'
      },
      {
        icon_url: '/icons/order-process/moci20k9-l5lac0u.svg',
        title: 'PCB Assembly'
      },
      {
        icon_url: '/icons/order-process/moci20k9-bc3f77v.svg',
        title: 'Mechanical Fabrication'
      },
      {
        icon_url: '/icons/order-process/moci20k9-sudxhob.svg',
        title: 'Box Build Assembly'
      },
      {
        icon_url: '/icons/order-process/moci20k9-qrmaz0u.svg',
        title: 'Functional Testing'
      },
      {
        icon_url: '/icons/order-process/moci20k9-r63tn4f.svg',
  ...
  faq: {
    ...
    items: [
      ...
      {
        question:
          'What makes RapidDirect different from other manufacturing platforms or intermediaries?',
        answer:
